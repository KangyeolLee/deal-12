...
// 기존 포스트 내용 수정하는 쿼리
export const UPDATE_POST = ({ post_id, title, location_id, category_id, content, price, state, thumbnail}: PostUpdateTYpe) => `
...
export const UPDATE_POST_STATE_BY_POSTID = ({ post_id, state}: { post_id: number, state: string }) => `
